    ...
    <?php if ($lisensiValid) : ?>
        <div class="col-md-4 col-lg-4">
            <div class="card card-block card-stretch card-height">
                <div class="card-body" data-toggle="modal" data-target="#modalLisensiExpired">
...
<div class="modal fade" id="modalLisensiExpired" tabindex="-1" role="dialog" aria-labelledby="modalLisensiExpiredTitle" aria-hidden="true">
